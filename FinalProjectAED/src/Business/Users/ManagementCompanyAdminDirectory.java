 ...
 * @author ankitlall
 */
public class ManagementCompanyAdminDirectory {
    ArrayList<ManagementCompanyAdmin> mgtCompAdmin = new ArrayList<>();
    
    public ManagementCompanyAdminDirectory() {}
    
    public void createNewUser(ManagementCompanyAdmin compAdmin) {
