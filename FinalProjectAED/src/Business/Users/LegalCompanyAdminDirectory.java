 ...
 * @author ankitlall
 */
public class LegalCompanyAdminDirectory {
    ArrayList<LegalCompanyAdmin> legalCompAdmin = new ArrayList<>();
    
    public LegalCompanyAdminDirectory() {}
    
    public void createNewUser(LegalCompanyAdmin compAdmin) {
