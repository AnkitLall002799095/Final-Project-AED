 ...
 * @author ankitlall
 */
public class ElectricityCompanyAdminDirectory {
    ArrayList<ElectricityCompanyAdmin> elecCompAdmin = new ArrayList<>();
    
    public ElectricityCompanyAdminDirectory() {}
    
    public void createNewUser(ElectricityCompanyAdmin compAdmin) {
