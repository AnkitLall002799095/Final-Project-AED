 ...
 * @author ankitlall
 */
public class LegalContractFormCont extends javax.swing.JPanel {
    
     int appId;

    /**
     * Creates new form LegalContractFormCont
     */
    public LegalContractFormCont( int appId) {
        this.appId=appId;
        initComponents();
        populateCombobox();
    ...
    private String[] getDropdownValues() {
        return new String[] {"Management Company Form", "Electricity Company Form", "Water Company Form", "Gas Company Form", "Finance Company Form", "Legal Company Form"};
    }
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(47, 47, 47)
                .addComponent(formType, javax.swing.GroupLayout.PREFERRED_SIZE, 225, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void formTypeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_formTypeActionPerformed
        ...
        switch(selected) {
            ...
            case "Finance Company Form":
                contentPanel.add(new FinanceCompFormDetails(appId));
                break;
            case "Legal Company Form":
                contentPanel.add(new LegalCompForm(appId));
                break;
        }
